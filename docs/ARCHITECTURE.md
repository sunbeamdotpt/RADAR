...
| `schema/assessment.ts`    | Strict `Assessment` / `AssessmentReport` types and validators: 9 risk levels + `SEVERITY_ORDER` (report sort order). Unknown keys and wrong types are rejected, same posture as the component schema.                                                                                                                                                                                 |
